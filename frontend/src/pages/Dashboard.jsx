                              ...
                              {stocks.map(s => (
                                <tr key={s.stock_code}>
                                  <td>
                                    ...
                                    <span className="mono muted" style={{ fontSize: 11 }}>{s.stock_code}</span>
                                  </td>
                                  <td className="mono">{s.strength?.toFixed(1) ?? '—'}</td>
                                  <td className="mono">{s.rsi?.toFixed(1) ?? '—'}</td>
                                  <td>
                                    <Badge color={s.macd_bullish ? 'green' : 'red'}>
                                      {s.macd_bullish ? 'BULL' : 'BEAR'}
                                    </Badge>
                                  </td>
                                  <td className="mono">{s.bid_ask_ratio?.toFixed(2) ?? '—'}</td>
