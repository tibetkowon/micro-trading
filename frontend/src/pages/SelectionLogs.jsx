                        ...
                        <tbody>
                          {candidates.map((c) => {
                            ...
                            <tr key={c.stock_code} className="border-b border-gray-800 text-gray-400">
                              ...
                              <td className={`py-1 pr-3 text-right ${opd > 10 ? 'text-red-400' : opd > 3 ? 'text-yellow-400' : 'text-gray-400'}`}>
                                {opd != null && opd !== 0 ? opd.toFixed(1) + '%' : '-'}
                              </td>
                              <td className={`py-1 pr-3 text-right ${dm5 > 3 ? 'text-red-400' : dm5 > 1.5 ? 'text-yellow-400' : 'text-gray-400'}`}>
